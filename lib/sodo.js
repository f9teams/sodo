...
Sodo.prototype.execute = function(type, command, args){
  log.info("Type: ", type);
  ...
  if(this.resources[type]) {
    console.log("Type: ", this.resources[type]);
    if(this.resources[type][command]) {
      console.log("Command: ", this.resources[type][command]);
    } else {
      console.log("No command with name ", command);
    }
  } else {
    console.log("No type with name ", type);
  }
